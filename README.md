...
## Getting started
TODO: refactor and clean-up Readme

he following code snipped briefly shows how to execute $S^3$, a more detailed explanation is given below.
...
To check out the available geometry object classes you can run the following code:
````
...
For a more detailed description checkout the respective classes.
````
