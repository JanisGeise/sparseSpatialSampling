...
class ExportData:
    def __init__(self, s_cube: SparseSpatialSampling, write_new_file_for_each_field: bool = False, n_jobs: int = None,
                 n_neighbors: int = None, interpolate_at_vertices: bool = False):
        """
        Implements an Export class for interpolating the original snapshots onto the grid generated by S^3
        and exporting them to HDF5.

        :param s_cube: s_cube object containing the sampled grid
        :type s_cube: SparseSpatialSampling
        :param write_new_file_for_each_field: If True, each field is written to a new HDF5 file; if False,
            all fields are written to a single file
        :type write_new_file_for_each_field: bool
        :param n_jobs: Number of CPUs used for interpolation. If None, the same number of CPUs used for executing S^3
            will be used
        :type n_jobs: int | None
        :param n_neighbors: Number of neighbors to use for the KNN. If None, then 8 and 26 will be used
    ...
    def _fit_data(self, _coord: pt.Tensor, _data: pt.Tensor, _field_name: str, _n_snapshots_total: int = None) -> None:
        ...
        Note:
            The variables ``centers`` and ``vertices`` in this method denote the values of the field at the cell centers
            and cell nodes, respectively (not the node coordinates of the generated mesh).
        ...
        :param _field_name: Name of the field to export (e.g., ``'p'`` for pressure field)
        :type _field_name: str
        :param _n_snapshots_total: Total number of snapshots to be exported. If None, it is assumed
            that the provided data includes all snapshots
    ...
    def write_times(self, value: Union[str, list]) -> None:
        ...
        :param value: A single time step (str/int/float) or a list of time steps
        :type value: str | list
        :return: None
        :rtype: None
        """
    ...
    def new_file(self) -> bool:
        """
        Flag indicating whether a new HDF5 file should be created for each field.

        :return: True if a new file will be created for each field, False otherwise
        :rtype: bool
        """
    ...
    def save_name(self) -> str:
        ...
        :return: File name used for saving grid and data
        :rtype: str
        """
    ...
    def save_name(self, new_name: str) -> None:
        """
        Set a new base name for the output files.
        Resets initialization to ensure consistency with the new file name.
    ...
    def save_dir(self, new_path: str) -> None:
        ...
        :param new_path: Path to the save directory
        :type new_path: str
        :return: None
        :rtype: None
        """
