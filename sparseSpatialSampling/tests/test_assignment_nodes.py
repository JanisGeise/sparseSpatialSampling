...
def test_assignment_nodes_uniform_grid_2d():
    ...
    cell_idx12 = sampling._cells[list(sampling._leaf_cells)[7]]
...
def test_assignment_nodes_uniform_grid_3d_single_level():
    ...
    cell_idx1 = sampling._cells[list(sampling._leaf_cells)[0]]
    ...
    cell_idx2 = sampling._cells[list(sampling._leaf_cells)[1]]
    ...
    cell_idx3 = sampling._cells[list(sampling._leaf_cells)[2]]
    ...
    cell_idx4 = sampling._cells[list(sampling._leaf_cells)[3]]
    ...
    cell_idx5 = sampling._cells[list(sampling._leaf_cells)[4]]
    assert cell_idx5.index == 5
    ...
    cell_idx6 = sampling._cells[list(sampling._leaf_cells)[5]]
    ...
    cell_idx7 = sampling._cells[list(sampling._leaf_cells)[6]]
    assert cell_idx7.index == 7
    ...
    cell_idx8 = sampling._cells[list(sampling._leaf_cells)[7]]
