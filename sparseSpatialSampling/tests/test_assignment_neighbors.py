...
def test_assignment_nb_uniform_grid_2d():
    ...
    # take a few different cells and check if their nb's are assigned correctly
    ...
    cell_idx10 = sampling._cells[sampling._leaf_cells[5]]
    ...
    cell_idx20 = sampling._cells[sampling._leaf_cells[-1]]
...
def test_assignment_nb_uniform_grid_3d():
    ...
    cell_idx9 = sampling._cells[sampling._leaf_cells[0]]
    ...
    cell_idx43 = sampling._cells[sampling._leaf_cells[34]]
    ...
    cell_idx32 = sampling._cells[sampling._leaf_cells[23]]
