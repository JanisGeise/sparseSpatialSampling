...
class DataWriter:
    ...
    """
    def __init__(self, face_ids: pt.Tensor, nodes, centers, save_dir: str, domain_boundaries: list,
                 save_name: str = "data_final_grid", grid_name: str = "final grid", times: pt.Tensor = None) -> None:
        """
